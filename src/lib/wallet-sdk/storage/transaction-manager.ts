...
export class TransactionManager extends BaseManager implements StorageManager {

  // const { wallet, keyInfra } = useSelector((state: RootState) => state.coreReducer);

  KEY = 'TransactionManager';

 // TransactionManager > 0x5 => 0x234234234234 => blockNumber

  // TokensManager > 0x5 => 0x234234234234 => [{}]
...
export const transactionManager: TransactionManager = new TransactionManager();